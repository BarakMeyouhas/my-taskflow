...
"[project]/types/task.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class TaskService {
    ...
    async assignTask(taskId, assignmentData) {
        try {
            const response = await fetch("".concat(this.getBaseUrl(), "/api/task/").concat(taskId, "/assign"), {
                method: "POST",
                headers: this.getAuthHeaders(),
            ...
            if (!response.ok) {
                const errorData = await response.json().catch(()=>({}));
                throw new Error(errorData.message || "Failed to assign task: ".concat(response.statusText));
            }
            const data = await response.json();
            return data;
        } catch (error) {
    ...
    async getTaskAssignments(taskId) {
        try {
            const response = await fetch("".concat(this.getBaseUrl(), "/api/task/").concat(taskId, "/assignments"), {
                headers: this.getAuthHeaders()
            });
            if (!response.ok) {
                throw new Error("Failed to fetch assignments: ".concat(response.statusText));
            }
            const data = await response.json();
    ...
    async unassignTask(taskId, assignmentId) {
        try {
            const response = await fetch("".concat(this.getBaseUrl(), "/api/task/").concat(taskId, "/assignments/").concat(assignmentId), {
                method: "DELETE",
                headers: this.getAuthHeaders()
            });
            if (!response.ok) {
                const errorData = await response.json().catch(()=>({}));
                throw new Error(errorData.message || "Failed to unassign task: ".concat(response.statusText));
            }
        } catch (error) {
...
"[project]/components/UserAssignment.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/types/task.ts [app-client] (ecmascript)");
...
;
;
const UserAssignment = (param)=>{
    let { taskId, isOpen, onClose, onAssignmentChange } = param;
    _s();
    ...
    const [selectedRole, setSelectedRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Viewer);
    ...
    const loadAssignments = async ()=>{
        try {
            setIsLoading(true);
            setError(null);
            const fetchedAssignments = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["taskService"].getTaskAssignments(taskId);
    ...
    const handleAssignUser = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["taskService"].assignTask(taskId, assignmentData);
            // Reload assignments and notify parent
            await loadAssignments();
            onAssignmentChange === null || onAssignmentChange === void 0 ? void 0 : onAssignmentChange();
            // Reset form
            setUserEmail('');
            setSelectedRole(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Viewer);
        } catch (error) {
    ...
    const handleUnassign = async (assignmentId)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$taskService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["taskService"].unassignTask(taskId, assignmentId);
            await loadAssignments();
            onAssignmentChange === null || onAssignmentChange === void 0 ? void 0 : onAssignmentChange();
        } catch (error) {
    ...
    const getRoleDisplayName = (role)=>{
        switch(role){
            case __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Owner:
                return 'Owner';
            case __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Editor:
                return 'Editor';
            case __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Viewer:
                return 'Viewer';
            default:
                return 'Unknown';
        }
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Viewer,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Editor,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AssignmentRole"].Owner,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 197,
                                columnNumber: 15
                            }, ("TURBOPACK compile-time value", void 0)) : assignments.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: assignments.map((assignment)=>{
                                    var _assignment_user, _assignment_user1;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: ((_assignment_user = assignment.user) === null || _assignment_user === void 0 ? void 0 : _assignment_user.username) || 'Unknown User'
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/UserAssignment.tsx",
                                                                lineNumber: 219,
                                                                columnNumber: 25
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: "text-sm text-gray-500",
                                                                children: (_assignment_user1 = assignment.user) === null || _assignment_user1 === void 0 ? void 0 : _assignment_user1.email
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/UserAssignment.tsx",
                                                                lineNumber: 220,
                                                                columnNumber: 25
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "px-2 py-1 rounded-full text-xs font-medium ".concat(getRoleColor(assignment.role)),
...
_s(UserAssignment, "+njjkZxnruaqGAmXu0HPPQ7fn7k=");
_c = UserAssignment;
const __TURBOPACK__default__export__ = UserAssignment;
var _c;
__turbopack_context__.k.register(_c, "UserAssignment");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UserAssignment$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/UserAssignment.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$task$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/types/task.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
...
const TaskCard = (param)=>{
    let { id, title, description, status, priority, dueDate, createdAt, updatedAt, ownerId, owner, assignments = [], onUpdateTask, onDeleteTask, onAssignmentChange } = param;
    _s();
    ...
    const [isAssignmentOpen, setIsAssignmentOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "px-2 py-1 rounded-full text-xs font-medium ".concat(getPriorityColor(priority)),
                                    children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "px-3 py-1 rounded-full text-xs font-medium ".concat(getStatusColor(status)),
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: (_assignment_user = assignment.user) === null || _assignment_user === void 0 ? void 0 : _assignment_user.username
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/TaskCard.tsx",
                                                        lineNumber: 238,
                                                        columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "px-1 py-0.5 rounded text-xs ".concat(getRoleColor(assignment.role)),
                                                        children: getRoleDisplayName(assignment.role)
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/TaskCard.tsx",
                                                        lineNumber: 239,
                                        ...
                                        assignments.length > 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    status !== 'InProgress' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    status !== 'ToDo' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UserAssignment$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                taskId: id,
...
_s(TaskCard, "In+6U2UZWC51nW5DxGMFmfKihKY=");
_c = TaskCard;
...
_s(TaskCreateForm, "ZVltuVhE1XuPxugN5xsZhwdmCsI=");
_c = TaskCreateForm;
...
const TaskBoard = (param)=>{
    let { tasks, onCreateTask, onUpdateTask, onDeleteTask, onAssignmentChange } = param;
    _s();
...
_s(TaskBoard, "jFIGVvHe8U+1NUIWH6DVnsY4ZxY=");
_c = TaskBoard;
...
_s(Dashboard, "26pFup7jtL6OJ6wPzUtWbVs2CLY=");
_c = Dashboard;
...
//# sourceMappingURL=_697ce7e5._.js.map